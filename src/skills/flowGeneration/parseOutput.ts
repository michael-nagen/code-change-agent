...
import type { FlowArtifact } from './types.js';
 ...
 */
export function parseOutput(text: string): FlowArtifact {
...
function validate(raw: unknown): FlowArtifact {
  ...
  return {
    ...
    description: requireString({ obj, key: 'description' }),
    steps: requireStringArray({ obj, key: 'steps' }),
    mermaid: requireString({ obj, key: 'mermaid' }),
  };
}
